...
<div id="navbar">
	<ul>
		...
		<li><a href="hp.php">Grocery</a></li>
		<li><a href="hg.php">Electronics</a></li>		
	</ul>
</div>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Mens wear' AND fandom='Clothing' ORDER BY id ASC");
if($results){ 
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Womens wear' AND fandom='Clothing' ORDER BY id ASC");
if($results){ 
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
